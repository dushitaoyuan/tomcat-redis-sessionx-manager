...
import com.taoyuan.session.serializer.ISessionSerializer;
import com.taoyuan.session.serializer.JsonSerializer;
import com.taoyuan.session.serializer.Serializer;
import com.taoyuan.session.serializer.SessionSerializer;
...
public class RedisSessionManager extends ManagerBase implements Lifecycle {
  ...
  protected String sessionPrefix = "";//session prefix, session前缀，用户需要手动配置
  ...
  protected static ISessionSerializer serializer; //session序列化接口实现类
  protected String serializerName;//序列化实现HESSIAN,PROTOSTUFF,JACKJSON,kryo,JDK,FASTJSON
...
public String getSessionPersistPolicies() {
  ...
  public Session createSession(String requestedSessionId) {
    ...
    try {
      ...
      if (null != requestedSessionId) {
        ...
        do {
          sessionId =sessionPrefix+sessionIdWithJvmRoute(generateSessionId(), jvmRoute);
  ...
  public Session createEmptySession() {
     return new RedisSession(this, serializer.getSerializer());
  }
  ...
  private void initializeSerializer() throws ClassNotFoundException, IllegalAccessException, InstantiationException {
    ...
    serializer =new SessionSerializer(Serializer.SerializeEnum.match(serializerName, Serializer.SerializeEnum.JDK).serializer);
    log.info("Attempting to use serializer :" + serializer.toString());
  }
